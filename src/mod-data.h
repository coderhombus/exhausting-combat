...
inline constexpr auto STAM_AV        = "Stamina.ActorValue";
inline constexpr auto SETTING_PLAYER = "Player";
...
inline constexpr auto getMaxCarryWeight                 = "GetMaxCarryWeight";
inline constexpr RE::PerkEntryPoint getMaxCarryWeightEP = RE::PerkEntryPoint::kGetMaxCarryWeight;

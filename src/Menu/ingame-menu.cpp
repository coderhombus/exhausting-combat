...
void FMenu::StaminaTool::DrawNPCs()
{
    ...
    FUCKUtil::Checkbox(LAB::npc_weight_mode.c_str(), VAR::npc_weight_mode, CONFIG::equipped_weight_only_npc,
                       TOOL::npc_weight_mode.c_str());
    ...
    FUCKUtil::SliderFloat(LAB::npc_attack_mult.c_str(), VAR::npc_attack_mult, CONFIG::stamina_mult_attack_npc, 0.0,
                          50.0, TOOL::npc_attack_mult.c_str());
    ...
    // FUCKUtil::SliderFloat(LAB::npc_jump_cost.c_str(), VAR::npc_jump_cost, CONFIG::stamina_cost_jump_npc, 0.0, 50.0,
    //                       TOOL::npc_jump_cost.c_str());
    // FUCKUtil::SliderFloat(LAB::npc_horseride_sprint_cost.c_str(), VAR::npc_horseride_sprint_cost,
    //                       CONFIG::stamina_cost_sprint_horse_npc, 0.0, 20.0, TOOL::npc_horseride_sprint_cost.c_str());
    FUCK::Unindent();
};
...
void FMenu::StaminaTool::DrawAV()
{
    ...
    FUCKUtil::SliderFloat(LAB::stamina_av_mult_block.c_str(), VAR::stamina_av_mult_block, CONFIG::stamina_av_mult_block,
                          0.0, 1.0, TOOL::stamina_av_mult_block.c_str());
    ...
    FUCKUtil::SliderFloat(LAB::stamina_av_mult_sneak.c_str(), VAR::stamina_av_mult_sneak, CONFIG::stamina_av_mult_sneak,
                          0.0, 1.0, TOOL::stamina_av_mult_sneak.c_str());
